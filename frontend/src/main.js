...
pluralCaseList.push( {plural: "reserves", pascal: "Reserve"} )

pluralCaseList.push( {plural: "lends", pascal: "Lend"} )

pluralCaseList.push( {plural: "reserveReqLists", pascal: "ReserveReqList"} )
pluralCaseList.push( {plural: "payments", pascal: "Payment"} )

pluralCaseList.push( {plural: "myPages", pascal: "MyPage"} )

pluralCaseList.push( {plural: "myPages", pascal: "MyPage"} )
pluralCaseList.push( {plural: "sales", pascal: "Sale"} )
